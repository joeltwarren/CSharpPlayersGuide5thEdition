    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int RecursionTest(int start)
            {
                ...
                if (start == 0) return start; // if start is equal to zero the already then it will stop the program.
                return RecursionTest(start - 1); // this calls the RecursionTest Method until start is equal to 0
