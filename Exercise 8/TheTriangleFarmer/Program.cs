namespace TheTriangleFarmer
{
    internal class Program
    {
        ...
        {
            /*
             * As you pass through the fields near Arithmetica City, you encounter P-Thag, a triangle farmer, scratching number in the dirt.
             * "What is all of that writing for?" you ask.
             * I'm just trying to calculate the are of all of my triangles. They sell by their size. The bigger they are, the more they are worth! But I have many triangles
